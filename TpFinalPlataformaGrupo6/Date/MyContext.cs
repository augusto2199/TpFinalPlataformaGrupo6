...
namespace TpFinalPlataformaGrupo6.Date
{
    public class MyContext: DbContext
    {
        ...
        {
            var configurartion = new ConfigurationBuilder()
                .SetBasePath(Directory.GetCurrentDirectory())
                .AddJsonFile("appsettings.json")
                .Build();

            var connectionString = configurartion.GetConnectionString("Context");
        ...
        public DbSet<TpFinalPlataformaGrupo6.Models.UsuarioCajaDeAhorro>? UsuarioCajaDeAhorro { get; set; }
    }
}
