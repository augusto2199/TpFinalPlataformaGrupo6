...
namespace TpFinalPlataformaGrupo6.Migrations
{
    ...
    [Migration("20241213042426_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.CajaDeAhorro", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.Movimiento", b =>
                {
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.Pago", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.PlazoFijo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.TarjetaDeCredito", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.UsuarioCajaDeAhorro", b =>
                {
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.Movimiento", b =>
                {
                    b.HasOne("TpFinalPlataformaGrupo6.Models.CajaDeAhorro", "caja")
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.Pago", b =>
                {
                    b.HasOne("TpFinalPlataformaGrupo6.Models.Usuario", "usuario")
                        .WithMany("pagos")
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.PlazoFijo", b =>
                {
                    b.HasOne("TpFinalPlataformaGrupo6.Models.Usuario", "titular")
                        .WithMany("pf")
                        .HasForeignKey("num_usr")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TpFinalPlataformaGrupo6.Models.UsuarioCajaDeAhorro", b =>
                {
                    b.HasOne("TpFinalPlataformaGrupo6.Models.CajaDeAhorro", "cajaAhorro")
